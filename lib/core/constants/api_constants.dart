...
class ApiConstants {
  ...
  // ============================================
  // 🔧 CONFIGURAÇÃO: Altere aqui para trocar entre ambientes
  // ============================================
  
  // OPÇÃO 1: Localhost com ADB reverse (Emulador com port forwarding)
  static const String _host = 'localhost';
  
  // OPÇÃO 2: IP da rede local (Dispositivo físico E Emulador sem ADB reverse)
  // static const String _host = '192.168.0.11';
